...
Carnet: HS19011
Nombre: Edwin Alexander
Carnet: Hernandez Sanchez
*/
...
function obtenerProductos() {
	 fetch('https://api-generator.retool.com/tmJNJF/productos')
		.then(res => res.json())
		.then(data => {
			productos = data;
			productos.forEach(
...
function eliminarProductos(iden) {
	fetch('https://api-generator.retool.com/tmJNJF/productos/'+iden, { method: "DELETE" })
